...
//		assertTrue(commandParser.ValidCommands(userinput, commands, jta, cp));
//
...
//
//		String userinput = "Count = 1";
//		commandParser.ValidCommands(userinput, commands, jta, cp); // set the variable
//		
//		// test that the parser accepts the string as a valid command
//		assertTrue(commandParser.ValidCommands(loopstring, commands, jta, cp));
//		
